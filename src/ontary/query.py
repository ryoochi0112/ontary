...
class GuardedQuery:
    ...
    def exists(
        ...
        *,
        ...
        return self.count(consumer, obj_type, where, trace=trace) > 0
    ...
    def count_contributors(
        ...
        **complementary differencing** across two released selections:
        ...
        visible = self._visible_rows(consumer, obj_type, disclosure.where, trace)
    ...
    def _aggregate(
        ...
        *,
        ...
        visible = self._visible_rows(consumer, obj_type, normalized_where, trace)
