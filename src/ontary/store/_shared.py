...
from ontary.errors import AuthorityError, ValidationFailed
...
def prepare_insert(
    ...
    *,
    ...
    UUID fallback is deliberately store-owned and is not runtime-seamed; tests
    that need deterministic object IDs should pass explicit primary keys."""
