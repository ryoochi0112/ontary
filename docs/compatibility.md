...
```toml
dependencies = [
  "ontary @ git+https://github.com/ryoochi0112/ontary@v0.9.0",
]
```

The practical difference: **a git ref gives you no patch updates for free.** Moving to
`v0.9.1` is an edit, which is more friction but also means nothing changes underneath you
